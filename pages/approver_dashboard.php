...
<div class="container-fluid" id="pending_reports" style="display: block;">   
    <div class="pending_dashboard">
        <div class="card shadow mb-4">
            <div class="card-body">
                <h2 class="text-left">Pending Approvals</h2>
                <p class="text-left">Review and approve trouble report requests.</p> 
...
<div class="container-fluid" id="approved_reports" style="display: none;">   
    <div class="approved_dashboard">
        <div class="card shadow mb-4">
            <div class="card-body">
                <h2 class="text-left">Approved Reports</h2>
                <p class="text-left">View all approved trouble report requests.</p> 
...
<div class="container-fluid" id="rejected_reports" style="display: none;">   
    <div class="rejected_dashboard">
        <div class="card shadow mb-4">
            <div class="card-body">
                <h2 class="text-left">Rejected Reports</h2>
                <p class="text-left">View all rejected trouble report requests.</p> 
