      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" class="form_table d-flex justify-content-center align-items-center">
                ...
                <input type="submit" name="response_request" class="btn btn-primary" value="Response" style="display: <?php echo $_SESSION['viewer_request'] == 'ongoing' && $view_request['dept_status'] == 0 ? 'block' : 'none' ?>;" disabled>
